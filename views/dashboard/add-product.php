    ...
    <form class="max-w-sm mx-auto mt-10" action="/product/store" method="POST">
      ...
      <div class="mb-5">
        ...
        <div class="relative">
          ...
          <input type="number" name="product_price" id="product_price" class="pl-6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
        </div>
      </div>
